(() => {
  const css = `
    ...
    .text-add{position:absolute;z-index:7;right:14px;top:50%;transform:translateY(-50%);width:38px;height:38px;border:1px solid #ffffff88;border-radius:50%;background:#171715;color:#d9ff47;font:800 19px/1 Arial,sans-serif;box-shadow:0 4px 16px #0007}
